...
public sealed class MarketQuoteSnapshotEntity
{
    ...
    public required string Symbol { get; set; } public required string Provider { get; set; } public DateTimeOffset Timestamp { get; set; }
...
public sealed class OptionContractSnapshotEntity
{
    ...
    public required string OptionSymbol { get; set; } public required string UnderlyingSymbol { get; set; } public required string Provider { get; set; } public DateTimeOffset Timestamp { get; set; } public DateOnly Expiration { get; set; } public decimal Strike { get; set; } public OptionType OptionType { get; set; }
